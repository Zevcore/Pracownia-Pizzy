...
<body>
    ...
    <header class="header">
        <ul class="menu">
            ...
            <li class="submenu"><a href="menu"><i class="fas fa-pizza-slice"></i> Menu</a></li>
            <li class="submenu"><a href="order"><i class="fas fa-utensils"></i> Zamów</a></li>
            <li class="submenu"><a href="contact"><i class="far fa-address-book"></i> Kontakt</a></li>
        </ul>

        <ul class="menu-contact">
            <li class="submenu"><a href="contact"><i class="fas fa-phone-square-alt"></i> +48 111-111-111</a></li>
